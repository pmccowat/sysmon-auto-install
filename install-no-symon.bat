...
ping localhost
@powershell Invoke-WebRequest -Uri "https://raw.githubusercontent.com/pmccowat/sysmon-auto-install/master/ossec.conf" -OutFile "C:\Source\Sysmon\ossec.conf"

xcopy %SYSMON_BIN%\ossec.conf C:\PROGRA~2\ossec-agent /q /y
...
ping localhost 
powershell Invoke-WebRequest -Uri "https://raw.githubusercontent.com/pmccowat/sysmon-auto-install/master/ossec.conf" -OutFile "C:\Source\Sysmon\ossec.conf" 
xcopy C:\Source\sysmon\ossec.conf C:\PROGRA~2\ossec-agent /q /y 
ping localhost 
net start Wazuh